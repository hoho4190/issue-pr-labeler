...
describe('Integration | Local(run) | Registry: commit-message-bodies.property', () => {
  ...
  const testCases: ConditionPropertyTestCase[] = [
    {
      ...
      expectedMatch: 'match',
      reason: 'at least one commit body matches the regex pattern'
    },
    {
      tc: 'TC02',
      eventName: EventType.PullRequest,
      ...
      reason: 'no commit body matches the regex pattern'
    }
  ]
