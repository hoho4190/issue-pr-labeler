...
describe('Integration | Local(run) | Registry: base-branch.property', () => {
  ...
  const testCases: ConditionPropertyTestCase[] = [
    {
      ...
      expectedMatch: 'match',
      reason: 'base branch matches the regex pattern'
    },
    {
      tc: 'TC02',
      eventName: EventType.PullRequest,
      ...
      reason: 'base branch does not match the regex pattern'
    },
    {
      tc: 'TC03',
      eventName: EventType.PullRequest,
      ...
      expectedMatch: 'match',
      reason: 'base branch equals the configured string value'
    },
    {
      tc: 'TC04',
      eventName: EventType.PullRequest,
      tagName: ConditionValueTagType.String,
      expectedMatch: 'mismatch',
      reason: 'base branch differs from the configured string value'
    }
  ]
