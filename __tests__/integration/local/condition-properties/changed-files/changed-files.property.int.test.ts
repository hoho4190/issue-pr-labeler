...
describe('Integration | Local(run) | Registry: changed-files.property', () => {
  ...
  const testCases: ConditionPropertyTestCase[] = [
    {
      ...
      tagName: ConditionValueTagType.GlobPattern,
      expectedMatch: 'match',
      reason: 'at least one changed file matches the glob pattern'
    },
    {
      tc: 'TC02',
      eventName: EventType.PullRequest,
      ...
      reason: 'no changed file matches the glob pattern'
    },
    {
      tc: 'TC03',
      eventName: EventType.PullRequest,
      tagName: ConditionValueTagType.String,
      expectedMatch: 'match',
      reason: 'at least one changed file equals the configured string'
    },
    {
      tc: 'TC04',
      eventName: EventType.PullRequest,
      tagName: ConditionValueTagType.String,
      expectedMatch: 'mismatch',
      reason: 'no changed file equals the configured string'
    }
  ]
