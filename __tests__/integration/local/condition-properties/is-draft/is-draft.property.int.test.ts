...
describe('Integration | Local(run) | Registry: is-draft.property', () => {
  ...
  const testCases: ConditionPropertyTestCase[] = [
    {
      ...
      tagName: ConditionValueTagType.Boolean,
      expectedMatch: 'match',
      reason: 'draft status equals the configured boolean value'
    },
    {
      tc: 'TC02',
      eventName: EventType.PullRequest,
      ...
      reason: 'draft status differs from the configured boolean value'
    }
  ]
