...
describe('Integration | Local(run) | Registry: head-branch.property', () => {
  ...
  const testCases: ConditionPropertyTestCase[] = [
    {
      ...
      expectedMatch: 'match',
      reason: 'head branch matches the regex pattern'
    },
    {
      tc: 'TC02',
      eventName: EventType.PullRequest,
      ...
      reason: 'head branch does not match the regex pattern'
    },
    {
      tc: 'TC03',
      eventName: EventType.PullRequest,
      ...
      expectedMatch: 'match',
      reason: 'head branch equals the configured string value'
    },
    {
      tc: 'TC04',
      eventName: EventType.PullRequest,
      tagName: ConditionValueTagType.String,
      expectedMatch: 'mismatch',
      reason: 'head branch differs from the configured string value'
    }
  ]
