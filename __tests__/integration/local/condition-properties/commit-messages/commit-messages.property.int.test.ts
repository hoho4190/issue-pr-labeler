...
describe('Integration | Local(run) | Registry: commit-messages.property', () => {
  ...
  const testCases: ConditionPropertyTestCase[] = [
    {
      ...
      expectedMatch: 'match',
      reason: 'at least one commit message matches the regex pattern'
    },
    {
      tc: 'TC02',
      eventName: EventType.PullRequest,
      ...
      reason: 'no commit message matches the regex pattern'
    }
  ]
