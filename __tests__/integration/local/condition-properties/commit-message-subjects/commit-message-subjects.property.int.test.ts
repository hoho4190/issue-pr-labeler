...
describe('Integration | Local(run) | Registry: commit-message-subjects.property', () => {
  ...
  const testCases: ConditionPropertyTestCase[] = [
    {
      ...
      expectedMatch: 'match',
      reason: 'at least one commit subject matches the regex pattern'
    },
    {
      tc: 'TC02',
      eventName: EventType.PullRequest,
      ...
      reason: 'no commit subject matches the regex pattern'
    }
  ]
