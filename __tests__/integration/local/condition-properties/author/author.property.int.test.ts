...
describe('Integration | Local(run) | Registry: author.property', () => {
  ...
  const testCases: ConditionPropertyTestCase[] = [
    {
      ...
      expectedMatch: 'match',
      reason: 'author matches the regex pattern'
    },
    {
      tc: 'TC02',
      eventName: EventType.Issue,
      ...
      reason: 'author does not match the regex pattern'
    },
    {
      tc: 'TC03',
      eventName: EventType.Issue,
      ...
      expectedMatch: 'match',
      reason: 'author equals the configured string value'
    },
    {
      tc: 'TC04',
      eventName: EventType.Issue,
      tagName: ConditionValueTagType.String,
      expectedMatch: 'mismatch',
      reason: 'author differs from the configured string value'
    },
    {
      tc: 'TC05',
