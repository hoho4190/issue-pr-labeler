...
describe('Integration | Local(run) | Registry: actor.property', () => {
  ...
  const testCases: ConditionPropertyTestCase[] = [
    {
      ...
      expectedMatch: 'match',
      reason: 'actor matches the regex pattern'
    },
    {
      tc: 'TC02',
      eventName: EventType.Issue,
      ...
      reason: 'actor does not match the regex pattern'
    },
    {
      tc: 'TC03',
      eventName: EventType.Issue,
      ...
      expectedMatch: 'match',
      reason: 'actor equals the configured string value'
    },
    {
      tc: 'TC04',
      eventName: EventType.Issue,
      tagName: ConditionValueTagType.String,
      expectedMatch: 'mismatch',
      reason: 'actor differs from the configured string value'
    },
    {
      tc: 'TC05',
