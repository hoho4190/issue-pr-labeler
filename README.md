...
> - References:
>   - [W3Schools RegExp Reference](https://www.w3schools.com/jsref/jsref_obj_regexp.asp)
...
- Use the `pull_request_target` event to allow Labeler to work even when you open a pull request from a forked
  repository to an upstream repository.
