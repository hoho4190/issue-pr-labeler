...
English | [한국어](/docs/next/policy-rule-evaluation.ko.md)
...
> [!NOTE]
>
> See [`skipIfBot`](/docs/next/configuration-guide.md#31-skipifbot).

## `removeUnmatchedLabels` Option Policy

> [!NOTE]
>
> See [`removeUnmatchedLabels`](/docs/next/configuration-guide.md#32-removeunmatchedlabels).
