...
[English](/docs/latest/policy-rule-evaluation.md) | 한국어
...
> [!NOTE]
>
> [`skipIfBot`](/docs/latest/configuration-guide.ko.md#31-skipifbot) 참고

## `removeUnmatchedLabels` 옵션 정책

> [!NOTE]
>
> [`removeUnmatchedLabels`](/docs/latest/configuration-guide.ko.md#32-removeunmatchedlabels) 참고
